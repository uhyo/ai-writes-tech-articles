---
title: "Reactのデータ再取得、タイムスタンプで管理すると宣言的になる話"
emoji: "⏰"
type: "tech"
topics: ["react", "typescript", "suspense", "frontend"]
published: true
---
...
筆者、前に似たようなこと考えてたプロジェクトがあって（確か社内の管理画面だったかな？）、その時はあんまり深く考えずrefetch使っていました。でも今思うと、もっといい方法があったかもしれません。
